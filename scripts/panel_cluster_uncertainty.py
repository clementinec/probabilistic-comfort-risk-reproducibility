#!/usr/bin/env python3
"""Clustered uncertainty audit for the case-level future-weather panel.
...
DEFAULT_MANIFEST = REPO_ROOT / "data" / "panel_manifest.csv"
DEFAULT_MEAN = (
    REPO_ROOT
    / "restricted_inputs"
    / "legacy_summaries"
    / "mean_tail_case_summary.csv"
)
DEFAULT_ZONE = (
    REPO_ROOT
    / "restricted_inputs"
    / "legacy_summaries"
    / "zone_size_case_summary.csv"
)
SEED = 20260729
N_BOOT = 10_000
