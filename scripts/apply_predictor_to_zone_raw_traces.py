...
DEFAULT_MODEL = ROOT / "models" / "tsv_predictor_bundle_no_pmv.joblib"
DEFAULT_OUT = ROOT / "restricted_inputs" / "simulation_traces_no_pmv"
...
def main() -> int:
    ...
    if args.combined:
        combined = args.output_dir / runner.COMBINED_TRACE_NAME
