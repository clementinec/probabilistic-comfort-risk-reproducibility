#!/usr/bin/env python3
"""Exact-spec contributor-grouped validation for the TSV predictor.

This script matches the deployed 400-tree model configuration
...
DEFAULT_OUT = REPO_ROOT / "outputs" / "validation" / "grouped"
