...
DEFAULT_DATA = ROOT / "restricted_inputs" / "thermal_comfort" / "newin_with_bmr.csv"
DEFAULT_MODEL_DIR = ROOT / "models"
DEFAULT_OUT = ROOT / "outputs" / "validation" / "predictor_heldout"
...
def main() -> int:
    ...
    primary = load_bundle(args.model_dir / "tsv_predictor_bundle.joblib")
    no_pmv = load_bundle(args.model_dir / "tsv_predictor_bundle_no_pmv.joblib")
