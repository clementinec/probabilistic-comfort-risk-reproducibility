#!/usr/bin/env python3
"""Metabolic-spread diagnostic for the 144-case future-weather panel.
...
DEFAULT_OUT = ROOT / "outputs" / "metabolic_spread" / "mean_zone"
MET_W_PER_M2 = 58.2
...
def write_markdown(
    ...
    with path.open("w", encoding="utf-8") as f:
        ...
        f.write(
            ...
            "future-weather diagnostic panel; raw per-zone states were not retained in the trace "
