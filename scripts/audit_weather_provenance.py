#!/usr/bin/env python3
"""Audit the future-weather provenance and selected EPW panel.
...
OUT_DEFAULT = ROOT / "outputs" / "weather" / "provenance"
GENERATOR_REFERENCE = (
    HPH / "method_sources" / "apply_climate_delta_batch.py"
)
SAMY_METHOD_SOURCE = (
    HPH / "method_sources" / "sAMY_manuscript.tex"
)
