#!/usr/bin/env python3
"""Build the Paper A weather-case manifest from the HPH selected EPWs."""
...
WORKSPACE_ROOT = REBUILD_ROOT.parents[1]
DEFAULT_PANEL = WORKSPACE_ROOT / "HPH_Carbon_Entitlement/data/interim/cmip_weather_panel.csv"
DEFAULT_WEATHER_ROOT = WORKSPACE_ROOT / "HPH_Carbon_Entitlement/weather/cmip_selected_years"
DEFAULT_OUT = REBUILD_ROOT / "data" / "panel_manifest.csv"
