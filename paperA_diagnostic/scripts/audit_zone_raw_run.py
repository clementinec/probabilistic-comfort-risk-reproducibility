#!/usr/bin/env python3
"""Audit a zone-raw diagnostic run before downstream Paper A analyses."""
...
DEFAULT_RUN = ROOT / "runs" / "diagnostic_reference_zone_raw_full"
DEFAULT_OUT = ROOT / "diagnostics" / "zone_raw_run_qa"
