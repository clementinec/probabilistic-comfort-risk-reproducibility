#!/usr/bin/env python3
"""Audit Paper A diagnostic-reference trace files without loading all cases at once."""
...
DEFAULT_TRACE_DIR = REBUILD_ROOT / "runs" / "diagnostic_reference" / "traces"
DEFAULT_OUT = REBUILD_ROOT / "diagnostics" / "trace_schema_audit.csv"
