#!/usr/bin/env python3
"""Zone-resolved metabolic-spread diagnostic for Paper A.
...
`run_medium_office_diagnostic_panel.py`:
...
DEFAULT_MODEL = ROOT / "runs" / "diagnostic_reference_zone_raw_full" / "models" / "control_predictors.joblib"
DEFAULT_OUT = ROOT / "diagnostics" / "metabolic_spread_zone_raw"
BASE_USECOLS = {
    "weather",
    "month",
    "day",
