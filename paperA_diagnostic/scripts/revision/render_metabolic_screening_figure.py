...
DEFAULT_INPUT = (
    ROOT / "paperA_rebuild/diagnostics/zone_metabolic_profile_distribution"
)
DEFAULT_OUTPUT = (
    ROOT / "paperA_R01/04_analysis/outputs/terminology_figures"
)

os.environ.setdefault(
    "MPLCONFIGDIR", str(ROOT / "paperA_R01/04_analysis/.mplconfig")
)
os.environ.setdefault(
    "XDG_CACHE_HOME", str(ROOT / "paperA_R01/04_analysis/.mplconfig")
)
